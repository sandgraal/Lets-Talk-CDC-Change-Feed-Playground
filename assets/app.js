...
const FALLBACK_SCENARIOS = [
  ...
  },
  {
    ...
    description: "Keep orders and order_items changes atomic across downstream consumers.",
    highlight: "Toggle apply-on-commit to watch multi-table writes stay consistent.",
    schema: [
      { name: "order_id", type: "string", pk: true },
      { name: "status", type: "string", pk: false },
    ...
    rows: [
      { order_id: "ORD-5001", status: "pending", total: 128.5 },
    ],
    ops: [
