...
| `ff_walkthrough` | Core duo | Enables the guided tooltips and glossary walkthrough experience. | **✅ Enabled** in `index.html` as of latest update. | Enabled after implementation validation; guided tour accessible via "Start guided walkthrough" button in quick start section. |
